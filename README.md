...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/dragon-ball-z-ultimate-battle-22-recomp/total)](https://github.com/Alexbeav/dragon-ball-z-ultimate-battle-22-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/dragon-ball-z-ultimate-battle-22-recomp/latest/total)](https://github.com/Alexbeav/dragon-ball-z-ultimate-battle-22-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/dragon-ball-z-ultimate-battle-22-recomp)](https://github.com/Alexbeav/dragon-ball-z-ultimate-battle-22-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Dragon Ball Z: Ultimate Battle 22** built on
[psxrecomp](https://github.com/mstan/psxrecomp) and
[recomp-ui](https://github.com/RetroPortingToolKit/recomp-ui).

This is an owned-input setup kit. You supply your own SLES-03736 disc image
...
|---|---|
| Region | Europe |
| Disc serial | SLES-03736 |
| Discs | 1 |
| Supported dump | Redump `Dragon Ball Z - Ultimate Battle 22 (Europe).cue` as CUE/BIN or CHD |
| BIOS | SCPH-5552 (Europe), 524288 bytes, SHA-256 `1faaa18fa820a0225e488d9f086296b8e6c46df739666093987ff7d8fd352c09` |

## Setup

1. Download the setup ZIP for your platform from [Releases](https://github.com/Alexbeav/dragon-ball-z-ultimate-battle-22-recomp/releases)
   and extract it into a writable folder.
2. Start `Dragon_Ball_Z_Ultimate_Battle_22` (`.exe` on Windows).
...
- Windows play testing on the private build this kit derives from: Playable, but Build Up in the main menu crashed. The DMA node-limit correction is in the pinned framework and was accepted on a test candidate.
...
named `diagnostic-mode.txt` next to `Dragon_Ball_Z_Ultimate_Battle_22.exe` and start the game as
usual, or run `Dragon_Ball_Z_Ultimate_Battle_22.exe --diagnostic`. Reproduce the problem, quit, then
run `Dragon_Ball_Z_Ultimate_Battle_22.exe --collect-diagnostics`: it writes `diagnostics-<date>.zip`
