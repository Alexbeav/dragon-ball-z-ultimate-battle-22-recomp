...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Dragon Ball Z: Ultimate Battle 22",
    .project_root_env = "DRAGON_BALL_Z_ULTIMATE_BATTLE_22_PROJECT_ROOT",
    .build_dir_env = "DRAGON_BALL_Z_ULTIMATE_BATTLE_22_BUILD_DIR",
    .force_setup_env = "DRAGON_BALL_Z_ULTIMATE_BATTLE_22_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLES_037.36_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Dragon_Ball_Z_Ultimate_Battle_22",
    .prepare_note =
